...
class Game:
    def __init__(self):
        pg.init()
        pg.font.init()
        self.myfont = pg.font.SysFont("Comic Sans MS", 20, bold=True)
    ...
    def load_data(self):
        ...
        sprites_character_folder = path.join(game_folder,'sprites/character32')
        ...
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_idle1.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run1.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run2.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run3.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run4.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run5.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run6.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run7.png')).convert_alpha())
        self.player_sprites.append(pg.image.load(path.join(sprites_character_folder, 'body_run8.png')).convert_alpha())
